  ...
  <body>
   ...
   <div class="me" > <div class="container1">
	...
	<div class="container2">
      ...
      <form class="form-signup" method = "post" action = "signupcheck.php">
        <h2 class="form-signup-heading">Create Account(As Customer)</h2>
        <label for="Name" class="sr-only">Name </label>
        <input type="name" id="name" class="form-control" placeholder="name"name = "Name" required autofocus>
        
		<label for="Roll_no" class="sr-only">Roll Number </label>
        <input type="Roll_no" id="Roll_no" class="form-control" placeholder="Roll_no" name = "Roll_no" required autofocus>
		
		<label for="inputPassword" class="sr-only">Password</label>
        <input type="password" id="inputPassword" class="form-control" placeholder="Password" name = "password" required>
        
        <button class="btn btn-lg btn-primary btn-block" type="submit" value = "Sign Up" name = "Submit">Sign Up</button>
      </form>
	 ...
	 <div class="container3">
      ...
      <form class="form-signin2">
        ...
        <label for="inputname" class="sr-only2"></label>
